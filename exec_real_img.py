...
num_epochs, batch_size, learning_rate, num_workers = 200, 32, 0.00015625, 4
...
def main(args):
    ...
    if args.continue_epoch:
        ...
        print("There is no saved parameter.")
    ...
    if args.test:
        print("The model will be tested with the trained parameter.")
        test(
            args=args,
            model=model,
            criterion=criterion,
